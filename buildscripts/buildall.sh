...
loadarch () {
	...
	if [ "$1" == "armv7l" ]; then
		...
		prefix_name=arm64
		export CFLAGS="-O3 -march=armv8.2-a+crypto+dotprod+fp16+i8mm+bf16+sha3 -mtune=cortex-x4 -fno-math-errno -fno-trapping-math -ffp-contract=fast -fomit-frame-pointer -pipe -ffunction-sections -fdata-sections"
