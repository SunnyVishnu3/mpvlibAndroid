...
object Utils {
    ...
    data class Versions(
        ...
        val libBluray: String,
        val libUdfRead: String,
        val libIconv: String,
        val uchardet: String,
        val bzip2: String,
        val xz: String,
        val zstd: String,
        val libArchive: String,
        val libDvdRead: String,
        val libDvdNav: String,
        val rubberBand: String,
        val shaderc: String,
        ...
        val dependencies: Map<String, String>
            get() = linkedMapOf(
                ...
                "libbluray" to libBluray,
                "libudfread" to libUdfRead,
                "libiconv" to libIconv,
                "uchardet" to uchardet,
                "bzip2" to bzip2,
                "xz" to xz,
                "zstd" to zstd,
                "libarchive" to libArchive,
                "libdvdread" to libDvdRead,
                "libdvdnav" to libDvdNav,
                "Rubber Band" to rubberBand,
                "shaderc" to shaderc,
